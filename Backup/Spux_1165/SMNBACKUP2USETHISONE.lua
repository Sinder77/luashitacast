...
local sets = {
    ...
    Idle_Priority = {
        ...
        Ear2 = { },
        Body = { 'Vermillion Cloak', 'Austere Robe', 'Seer\'s Tunic' },
        Hands = { 'Summoner\'s Brcr.', 'Austere Cuffs', 'Baron\'s Cuffs' },
        Ring1 = {'Electrum Ring', 'Astral Ring',},
        Ring2 = { 'Evoker\'s Ring', 'Electrum Ring', 'Astral Ring',},
        Back = {'White Cape', 'Cotton Cape',},
        Waist = {'Adept\'s Rope', 'Friar\'s Rope', },
        Legs = { 'Evoker\'s Spats', 'Windurstian Slops'		},
...
local function UpdateMacroSet(petName)
    ...
    if (macroData ~= nil) then
        ChangeMacroSet:oncef(1, macroData);
    end
end
