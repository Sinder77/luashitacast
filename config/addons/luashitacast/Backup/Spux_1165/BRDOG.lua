...
local sets = {
    Idle = {
        ...
        Head = 'Electrum Hairpin', --Emp Hairpin
		Body = 'Crow Jupon',
        Neck = 'Spirit Torque',
        Ear1 = 'Mythril Earring', --'Melody Earring',
        Ear2 = 'Reraise Earring', --
        Hands = 'Battle Gloves',
        Ring1 = 'Ether Ring',
        Ring2 = 'Astral Ring', --'Loyalty Ring',
        Back = 'Traveler\'s Mantle', --'Jester\'s Cape +1'
        Waist = 'Quick Belt',
        Legs = 'Crow Hose', 
        Feet = 'Light Soleas', 
		},
    ...
    Town = {
        ...
        --Sub = '',
        --Range = 'Faerie Piccolo',
        --Head = 'Noble\'s Ribbon',--'Electrum Hairpin', --crow
        --Neck = 'Spirit Torque',
    ...
    Song_Precast = { --Combo of FC and +HP. idleHP/.75 = required HP
		Main = '', 
        Sub = '',
        Range = '',
    ...
    Harp = {--use /forcestring in game to lock this on all songs, I personally just use Paeons
        Range = 'Maple Harp +1', -- This should be ur extra song harp, whichever you use
    },
    Foe = {
        Main = 'Light Staff',
        Sub = '',
        Range = 'Maple Harp +1', --{ Name = 'Gjallarhorn', AugTrial=3591 },
        Head = 'Noble\'s Ribbon',
        Neck = 'Bird Whistle',
        Ear1 = 'Mythril Earring',
        Ear2 = 'Reraise Earring',
    ...
    Buff = {
        ...
        Sub = '',
        Head = 'Noble\'s Ribbon',
        Neck = 'Spirit Torque', --'Bird Whistle',
        Ear1 = 'Melody Earring', --'Mythril Earring',
        Ear2 = 'Melody Earring', --'Reraise Earring',
        Body = 'Crow Jupon',
        Hands = 'Battle Gloves',
        Ring1 = 'Loyalty Ring',
        Ring2 = 'Loyalty Ring',
...
profile.OnLoad = function()
	...
	AshitaCore:GetChatManager():QueueCommand(-1, '/bind !END /warpring');
end
...
profile.HandleMidcast = function()
    ...
    elseif (spell.Skill == 'Singing') then
        ...
        if (string.contains(spell.Name, 'Elegy')) or (string.contains(spell.Name, 'Threnody')) or (string.contains(spell.Name, 'Finale')) or (string.contains(spell.Name, 'Lullaby')) then
            gFunc.EquipSet(sets.Wind);
        end
		if (string.contains(spell.Name, 'Minne')) then
			gFunc.EquipSet(sets.Harp);
		end
		if (string.contains(spell.Name, 'Etude')) then
			gFunc.EquipSet(sets.Harp);
		end
		if (string.contains(spell.Name, 'Threnody')) then
