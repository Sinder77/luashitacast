...
local sets = {
    Idle = {
        Main = 'Mythril Pick +1',
        Sub = 'Barbaroi Axe', --'Balance Buckler', --'Viking Axe',
        Ammo = 'Happy Egg',--'Voluspa Tathlum',
        Head = 'Alumine Salade',
        Neck = 'Ryl.Sqr. Collar',
        ...
        Waist = 'Life Belt',
        Legs = 'Republic Subligar', --'Crow Hose',
...
profile.OnLoad = function()
	...
	AshitaCore:GetChatManager():QueueCommand(-1, '/bind numpad0 /ja Fight <stnpc>');
	AshitaCore:GetChatManager():QueueCommand(-1, '/bind !` /ja Leave <me>');
...
profile.HandleMidcast = function()
    ...
    if (spell.Skill == 'Enhancing Magic') then
		...
		elseif (spell.Name == 'Tonko: Ichi') then
			gFunc.EquipSet(sets.Invisible);
        end
